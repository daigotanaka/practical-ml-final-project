...
variable. It can be observed from the plot that at most 20% of the variable are
significantly contributing to decrease the impurity. To save the computation
...
seemed promising to perform the classification on the test data set.
